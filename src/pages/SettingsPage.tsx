                ...
                <div className="bg-surface shadow rounded-lg overflow-hidden border border-gray-100 dark:border-none">
                    <div className="px-4 py-5 sm:p-6">
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center justify-between py-2 border-b border-gray-100 dark:border-gray-800 last:border-0 text-sm">
                                <div>
                                ...
                                <select
                                    ...
                                    className="mt-1 block w-32 rounded-md border-gray-200 dark:border-gray-700 bg-surface-hover py-2 pl-3 pr-10 text-base focus:border-primary focus:outline-none focus:ring-primary sm:text-sm text-text-primary"
                                >
